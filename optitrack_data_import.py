...
def create_dataset(sub_id, dataset_type, coordinate):
    scaler_path = os.environ["ONEDRIVE"] + "/研究/2020実験データ/CSV_BIN/" + sub_id + "/" + sub_id + "_scaler.pkl"
    global SEQ_LEN
    global STEP_SIZE
    global SKIP
...
def main():
    ...
    parser.add_argument('-subject_id', default=["T1_1109", "S1_1112", "H1_1202", "E1_1203", "Y1_1217", "A1_1217"], help='被験者IDのリスト')
